...
void HPGeCalibrationPlots_2019() {
	gStyle->SetOptStat(0);

	// ---------------------------- Co60 ------------------------------ //
	
	//TFile *co60_before_cal_file = TFile::Open("../../HistFiles/WithBeforeCal/Hist_52018_000.root");
	TFile *co60_before_cal_file = TFile::Open("../../HistFiles/WithAfterCal/Hist_52018_000.root");
	if(!co60_before_cal_file) {
        std::cout << "Error opening before calibration file \n";
        return;
    }
	//TFile *co60_after_cal_file = TFile::Open("../../HistFiles/WithBeforeCal/Sum_52169.root");
    TFile *co60_after_cal_file = TFile::Open("../../HistFiles/WithAfterCal/Sum_52169.root");
	...
	TH1D *h_co60_before_rawE = new TH1D("h_co60_before_rawE","^{60}Co Spectrum for Dec 2019 before and after calibration runs",10000,0,10000);
	h_co60_before_rawE->SetLineColor(kBlue);
	co60_tig_before_cal->Draw("gamma.rawE>>h_co60_before_rawE","", "goff");
	h_co60_before_rawE->GetYaxis()->SetRangeUser(10,10000000);
	...
	TH1D *h_co60_after_rawE = new TH1D("h_co60_after_rawE","^{60}Co Spectrum for Dec 2019 before and after calibration runs",10000,0,10000);
	...
	TLegend *legend = new TLegend(0.72,0.78,0.90,0.88);
   	legend->AddEntry(h_co60_before_rawE,"Before (Run 52018)","l");
   	legend->AddEntry(h_co60_after_rawE,"After (Run 52169)","l");
   	legend->Draw();
	
	c1->Update();
	//c1->SaveAs("SamCalibrationFile/Dec2019/WithBeforeCal/Co60.root");
	c1->SaveAs("SamCalibrationFile/Dec2019/WithAfterCal/Co60.root");
	...
	c4->Modified();
	c4->Update();
	//c4->SaveAs("SamCalibrationFile/Dec2019/WithBeforeCal/Co60_1173Fit.pdf");
	c4->SaveAs("SamCalibrationFile/Dec2019/WithAfterCal/Co60_1173Fit.pdf");
	// ---------------------------------------------------------------- //


	// ---------------------------- Co56 ------------------------------ //
	//TFile *co56_before_cal_file = TFile::Open("../../HistFiles/WithBeforeCal/Sum_52022.root");
	TFile *co56_before_cal_file = TFile::Open("../../HistFiles/WithAfterCal/Sum_52022.root");
	if(!co56_before_cal_file) {
        std::cout << "Error opening before calibration file \n";
        return;
    }
	//TFile *co56_after_cal_file = TFile::Open("../../HistFiles/WithBeforeCal/Sum_52170.root");
    TFile *co56_after_cal_file = TFile::Open("../../HistFiles/WithAfterCal/Sum_52170.root");
	...
	TH1D *h_co56_before_rawE = new TH1D("h_co56_before_rawE","^{56}Co Spectrum for Dec 2019 before and after calibration runs",10000,0,10000);
	h_co56_before_rawE->SetLineColor(kBlue);
	co56_tig_before_cal->Draw("gamma.rawE>>h_co56_before_rawE","", "goff");
	h_co56_before_rawE->GetYaxis()->SetRangeUser(10,10000000);
	...
	TH1D *h_co56_after_rawE = new TH1D("h_co56_after_rawE","^{56}Co Spectrum for Dec 2019 before and after calibration runs",10000,0,10000);
	...
	TLegend *legend2 = new TLegend(0.72,0.78,0.90,0.88);
   	legend2->AddEntry(h_co56_before_rawE,"Before (Run 52022)","l");
   	legend2->AddEntry(h_co56_after_rawE,"After (Run 52170)","l");
   	legend2->Draw();
	
	c2->Update();
	//c2->SaveAs("SamCalibrationFile/Dec2019/WithBeforeCal/Co56.root");
	c2->SaveAs("SamCalibrationFile/Dec2019/WithAfterCal/Co56.root");
	...
	c5->Modified();
	c5->Update();
	//c5->SaveAs("SamCalibrationFile/Dec2019/WithBeforeCal/Co56_1238Fit.pdf");
	c5->SaveAs("SamCalibrationFile/Dec2019/WithAfterCal/Co56_1238Fit.pdf");
	// ---------------------------------------------------------------- //
	
	
	// --------------------------- Eu152 ------------------------------ //
	//TFile *eu152_before_cal_file = TFile::Open("../../HistFiles/WithBeforeCal/Hist_52020_000.root");
	TFile *eu152_before_cal_file = TFile::Open("../../HistFiles/WithAfterCal/Hist_52020_000.root");
	if(!eu152_before_cal_file) {
        std::cout << "Error opening before calibration file \n";
        return;
    }
	//TFile *eu152_after_cal_file = TFile::Open("../../HistFiles/WithBeforeCal/Sum_52171.root");
    TFile *eu152_after_cal_file = TFile::Open("../../HistFiles/WithAfterCal/Sum_52171.root");
	...
	TH1D *h_eu152_before_rawE = new TH1D("h_eu152_before_rawE","^{152}Eu Spectrum for Dec 2019 before and after calibration runs",10000,0,10000);
	h_eu152_before_rawE->SetLineColor(kBlue);
	eu152_tig_before_cal->Draw("gamma.rawE>>h_eu152_before_rawE","", "goff");
	h_eu152_before_rawE->GetYaxis()->SetRangeUser(10,10000000);
	...
	TH1D *h_eu152_after_rawE = new TH1D("h_eu152_after_rawE","^{152}Eu Spectrum for Dec 2019 before and after calibration runs",10000,0,10000);
	...
	TLegend *legend3 = new TLegend(0.72,0.78,0.90,0.88);
   	legend3->AddEntry(h_eu152_before_rawE,"Before (Run 52020)","l");
   	legend3->AddEntry(h_eu152_after_rawE,"After (Run 52171)","l");
   	legend3->Draw();
	
	c3->Update();
	//c3->SaveAs("SamCalibrationFile/Dec2019/WithBeforeCal/Eu152.root");
	c3->SaveAs("SamCalibrationFile/Dec2019/WithAfterCal/Eu152.root");
	...
	c6->Modified();
	c6->Update();
	//c6->SaveAs("SamCalibrationFile/Dec2019/WithBeforeCal/Eu152_344Fit.pdf");
	c6->SaveAs("SamCalibrationFile/Dec2019/WithAfterCal/Eu152_344Fit.pdf");
	// ---------------------------------------------------------------- //
}
