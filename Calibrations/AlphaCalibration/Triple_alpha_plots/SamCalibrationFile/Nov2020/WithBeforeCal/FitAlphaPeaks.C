...
void FitAlphaPeaks() {
    ...
    TF1 *Pu_before_gaussian = new TF1("Pu_before_gaussian", "gaus", 5050, 5220);
    ...
    Pu_before_gaussian->SetRange(5030, 5250);  // extend for display

    TCanvas *c1 = new TCanvas("c1", "Gaussian fit of 239Pu alpha energy (before calibration)", 800, 600);
    alpha_peaks_before->GetXaxis()->SetRangeUser(5010, 5270);
    ...
    TF1 *Pu_after_gaussian = new TF1("Pu_after_gaussian", "gaus", 5050, 5220);
    ...
    Pu_after_gaussian->SetRange(5030, 5260);  // extend for display

    TCanvas *c2 = new TCanvas("c2", "Gaussian fit of 239Pu alpha energy (after calibration)", 800, 600);
    alpha_peaks_after->GetXaxis()->SetRangeUser(5010, 5275);
   ...
   // ----------------------------------------------------------- //
    ...
    // TF1 *Am_before_gaussian = new TF1("Am_before_gaussian", "gaus", 5380, 5570);
    ...
    // Am_before_gaussian->SetRange(5370, 5595);  // extend for display

    // TCanvas *c3 = new TCanvas("c3", "Gaussian fit of 241Am alpha energy (before calibration)", 800, 600);
    // alpha_peaks_before->GetXaxis()->SetRangeUser(5330, 5620);
    // alpha_peaks_before->Draw();
    ...
    // TF1 *Am_after_gaussian = new TF1("Am_after_gaussian", "gaus", 5415, 5550);
    ...
    // Am_after_gaussian->SetRange(5350, 5620);  // extend for display
    ...
    // TF1 *Cm_before_gaussian = new TF1("Cm_before_gaussian", "gaus", 5700, 5820);
    ...
    // Cm_before_gaussian->SetRange(5670, 5920);  // extend for display

    // TCanvas *c5 = new TCanvas("c5", "Gaussian fit of 244Cm alpha energy (before calibration)", 800, 600);
    // alpha_peaks_before->GetXaxis()->SetRangeUser(5650, 5940);
    // alpha_peaks_before->Draw();
    ...
    // TF1 *Cm_after_gaussian = new TF1("Cm_after_gaussian", "gaus", 5720, 5900);
    ...
    // Cm_after_gaussian->SetRange(5680, 5915);  // extend for display

    // TCanvas *c6 = new TCanvas("c6", "Gaussian fit of 244Cm alpha energy (after calibration)", 800, 600);
    // alpha_peaks_after->GetXaxis()->SetRangeUser(5665, 5940);
    // alpha_peaks_after->Draw();
