...
void FitAlphaPeaks() {
    ...
    alpha_peaks_before->GetXaxis()->SetRangeUser(5020, 5260);
    ...
    TF1 *Pu_after_gaussian = new TF1("Pu_after_gaussian", "gaus", 5055, 5290);
    ...
    Pu_after_gaussian->SetRange(5035, 5275);  // extend for display

    TCanvas *c2 = new TCanvas("c2", "Gaussian fit of 239Pu alpha energy (after calibration)", 800, 600);
    alpha_peaks_after->GetXaxis()->SetRangeUser(4990, 5300);
   ...
   // ----------------------------------------------------------- //
    ...
    // TF1 *Am_before_gaussian = new TF1("Am_before_gaussian", "gaus", 5450, 5480);
    ...
    // Am_before_gaussian->SetRange(5365, 5590);  // extend for display
    ...
    // TF1 *Am_after_gaussian = new TF1("Am_after_gaussian", "gaus", 5400, 5550);
    ...
    // Am_after_gaussian->SetRange(5370, 5580);  // extend for display
    ...
    // TF1 *Cm_before_gaussian = new TF1("Cm_before_gaussian", "gaus", 5740, 5820);
    ...
    // Cm_before_gaussian->SetRange(5665, 5910);  // extend for display

    // TCanvas *c5 = new TCanvas("c5", "Gaussian fit of 244Cm alpha energy (before calibration)", 800, 600);
    // alpha_peaks_before->GetXaxis()->SetRangeUser(5650, 5920);
    // alpha_peaks_before->Draw();
    ...
    // TF1 *Cm_after_gaussian = new TF1("Cm_after_gaussian", "gaus", 5700, 5860);
    ...
    // Cm_after_gaussian->SetRange(5670, 5930);  // extend for display

    // TCanvas *c6 = new TCanvas("c6", "Gaussian fit of 244Cm alpha energy (after calibration)", 800, 600);
    // alpha_peaks_after->GetXaxis()->SetRangeUser(5650, 5935);
    // alpha_peaks_after->Draw();
