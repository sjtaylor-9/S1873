...
//     Pu_before_gaussian->SetRange(5030, 5265);  // extend for display

//     TCanvas *c1 = new TCanvas("c1", "Gaussian fit of 239Pu alpha energy (before calibration)", 800, 600);
//     alpha_peaks_before->GetXaxis()->SetRangeUser(5000, 5290);
...
//     TF1 *Pu_after_gaussian = new TF1("Pu_after_gaussian", "gaus", 5050, 5260);
...
//     Pu_after_gaussian->SetRange(5035, 5265);  // extend for display

//     TCanvas *c2 = new TCanvas("c2", "Gaussian fit of 239Pu alpha energy (after calibration)", 800, 600);
//     alpha_peaks_after->GetXaxis()->SetRangeUser(5010, 5280);
...
//    // ----------------------------------------------------------- //
    ...
    // TF1 *Am_before_gaussian = new TF1("Am_before_gaussian", "gaus", 5400, 5500);
    ...
    // Am_before_gaussian->SetRange(5350, 5600);  // extend for display

    // TCanvas *c3 = new TCanvas("c3", "Gaussian fit of 241Am alpha energy (before calibration)", 800, 600);
    // alpha_peaks_before->GetXaxis()->SetRangeUser(5320, 5630);
    // alpha_peaks_before->Draw();
    ...
    // TF1 *Am_after_gaussian = new TF1("Am_after_gaussian", "gaus", 5430, 5550);
    ...
    // Am_after_gaussian->SetRange(5370, 5590);  // extend for display
    ...
    TF1 *Cm_before_gaussian = new TF1("Cm_before_gaussian", "gaus", 5700, 5880);
    ...
    Cm_before_gaussian->SetRange(5650, 5940);  // extend for display

    TCanvas *c5 = new TCanvas("c5", "Gaussian fit of 244Cm alpha energy (before calibration)", 800, 600);
    alpha_peaks_before->GetXaxis()->SetRangeUser(5600, 5960);
    alpha_peaks_before->Draw();
    ...
    TF1 *Cm_after_gaussian = new TF1("Cm_after_gaussian", "gaus", 5730, 5870);
    ...
    Cm_after_gaussian->SetRange(5680, 5910);  // extend for display

    TCanvas *c6 = new TCanvas("c6", "Gaussian fit of 244Cm alpha energy (after calibration)", 800, 600);
    alpha_peaks_after->GetXaxis()->SetRangeUser(5655, 5930);
    alpha_peaks_after->Draw();
