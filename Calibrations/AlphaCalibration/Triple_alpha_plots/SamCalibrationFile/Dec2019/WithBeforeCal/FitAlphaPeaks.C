...
void FitAlphaPeaks() {
    ...
    TF1 *Pu_before_gaussian = new TF1("Pu_before_gaussian", "gaus", 5147, 5168);
    ...
    Pu_before_gaussian->SetRange(5095, 5215);  // extend for display
   ...
   // ----------------------------------------------------------- //
    ...
    // TF1 *Am_before_gaussian = new TF1("Am_before_gaussian", "gaus", 5470, 5510);
    ...
    // Am_before_gaussian->SetRange(5430, 5540);  // extend for display
    ...
    // TF1 *Am_after_gaussian = new TF1("Am_after_gaussian", "gaus", 5485, 5520);
    ...
    // TF1 *Cm_before_gaussian = new TF1("Cm_before_gaussian", "gaus", 5790, 5845);
    ...
    // Cm_before_gaussian->SetRange(5745, 5865);  // extend for display
    ...
    // TF1 *Cm_after_gaussian = new TF1("Cm_after_gaussian", "gaus", 5810, 5845);
    ...
    // Cm_after_gaussian->SetRange(5755, 5885);  // extend for display
